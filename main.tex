...
The clearest result is a strong association between relation mapping type and predictive multiplicity.
The association with inverse relations is non-monotonic, with lower predictive multiplicity concentrated among relations with high inverse scores.
By contrast, symmetry, although commonly examined as a relation pattern in knowledge graph embedding, shows no clear association with predictive multiplicity after self-loop cases are excluded.
\end{eabstract}
