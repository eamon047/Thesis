...
TODO: Define one-to-one, one-to-many, many-to-one, and many-to-many mapping
types. Explain here why mapping type must be interpreted with prediction side,
and why the mapping-type experiments use side-aware aggregation.
